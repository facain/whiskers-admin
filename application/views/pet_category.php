...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <button class="btn btn-success" onclick="add_category ()"><i class="glyphicon glyphicon-plus"></i> Add Category</button>
...
$(document).ready(function() {
    ...
    table = $('#myTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/Category_controller/category_list')?>",
            "type": "POST"
        },
...
function edit_category(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/Category_controller/category_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
 ...
 function view_category(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('index.php/Category_controller/category_view')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/Category_controller/category_add')?>";
    } else {
        url = "<?php echo site_url('index.php/Category_controller/category_update')?>";
    }
...
function delete_category(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('index.php/Category_controller/category_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
