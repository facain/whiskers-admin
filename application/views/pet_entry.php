      ...
      <!--  <li class="header"></li> -->
        ...
        <li class="active treeview">
         ...
         <li><a href="<?php echo base_url();?>index.php/Entry_controller/entry"><i class="fa fa-list"></i>Pet Entries</a></li>
            ...
            <li><a href="<?php echo base_url();?>index.php/Breedcontroller/breed"><i class="fa fa-edit"></i>Pet Breed</a></li>
...
$(document).ready(function() {
    ...
    table = $('#myTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('index.php/Entry_controller/entry_list')?>",
            "type": "POST"
        },
...
function add_entry()
{
    ...
    $('.modal-title').text('Add Entry'); // Set Title to Bootstrap modal title
}
...
function edit_entry(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('index.php/Entry_controller/entry_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
 ...
 function view_entry(id)
{
    ...
    //Ajax Load data from ajax
    $.ajax({
        url : "<?php echo site_url('index.php/Entry_controller/entry_view')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="contactNumber"]').text(data.contact_number);
            $('[name="dateReg"]').text(data.date_registered);
            $('[name="dob"]').datepicker('update',data.dob);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('index.php/Entry_controller/entry_add')?>";
    } else {
        url = "<?php echo site_url('index.php/Entry_controller/entry_update')?>";
    }
...
function delete_entry(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('index.php/Entry_controller/entry_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Name of Pet</label>
                            <div class="col-md-9">
                                <input name="fullName" placeholder="Name" class="form-control" type="text" required>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Type of Animal</label>
                            <div class="col-md-9">
                                <select name="animalType" class="form-control"   >
                                <option value = "" style ="color:#999;" disabled selected>Select Animal Type</option>
                                    <?php
                                        foreach ($animalType as $key => $value) {
                                            echo "<option value='".$value->pet_id."' style = 'color:black'>".$value->pet_type."</option>";
                                        }
                                    ?>
                                </select>
                                <span class="help-block"></span>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <span name="email" placeholder="Contact Number" class="form-control" type="text" style="border-color: transparent;"></span>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <span name="contactNumber" placeholder="Contact Number" class="form-control" type="text" style="border-color: transparent;"></span>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <span name="dateReg" placeholder="Date Registered" class="form-control" style="border-color: transparent;"></span>
                                <span class="help-block"></span>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('select[name="animalType"]').on('change', function() {
            var animalID = $(this).val();
            if(animalID) {
                $.ajax({
                    url: "<?php echo site_url('index.php/Entry_controller/entry_search')?>/" + animalID,
                    type: "GET",
                    dataType: "json",
                    success:function(data) {
                        $('select[name="breed"]').empty();
                        $('select[name="breed"]').append('<option value="" disabled selected>'+ "Select Breed" +'</option>');
                        $.each(data, function(key, value) {
                            $('select[name="breed"]').append('<option value="'+ value.breed_id +'" style ="color:black">'+ value.breed_name +'</option>');
                        });
                    }
                });
            }else{
